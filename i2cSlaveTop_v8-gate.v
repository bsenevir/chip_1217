...
// Verification Directory fv/i2cSlaveTop_v8 
...
module chipBusController_p4(clk, rst, counter_val1, counter_val2,
  ...
  wire [2:0] samp_track;
  wire UNCONNECTED, ack_received2, clr_counter_reg,
       counterAccumulation_n_30, counterAccumulation_n_32,
       counterAccumulation_n_34, counterAccumulation_n_36,
       counterAccumulation_n_38;
  wire counterAccumulation_n_40, counterAccumulation_n_42,
       counterAccumulation_n_44, counterAccumulation_n_46,
       counterAccumulation_n_48, counterAccumulation_n_50,
       counterAccumulation_n_52, counterAccumulation_n_54;
  wire counterAccumulation_n_56, counterAccumulation_n_58,
       counterAccumulation_n_60, counterAccumulation_n_62,
       counterAccumulation_n_64, counterAccumulation_n_66,
       counterAccumulation_n_68, counterAccumulation_n_70;
  wire counterAccumulation_n_72, counterAccumulation_n_166,
       counterAccumulation_n_167, counterAccumulation_n_168,
       counterAccumulation_n_169, counterAccumulation_n_170,
       counterAccumulation_n_171, counterAccumulation_n_173;
  wire counterAccumulation_n_174, counterAccumulation_n_175,
       counterAccumulation_n_176, counterAccumulation_n_177,
       counterAccumulation_n_178, counterAccumulation_n_179,
       counterAccumulation_n_180, counterAccumulation_n_181;
  wire counterAccumulation_n_182, counterAccumulation_n_183,
       counterAccumulation_n_184, counterAccumulation_n_185,
       counterAccumulation_n_186, counterAccumulation_n_187, loadedVal,
       n_0;
  ...
  wire n_276, n_277, n_278, n_279, n_280, n_283, n_284, n_285;
  wire n_286, n_287, n_288, n_289, n_290, n_291, n_292, n_293;
  wire n_294, n_295, n_343, n_344, n_345, n_346, n_347, sentAddr;
  wire uut_n_14;
  ...
  increment_unsigned_51_52 counterAccumulation_inc_add_34_11_1(.A
       ...
       UNCONNECTED}));
  OR2X2 g2816(.A (n_295), .B (rst), .Y (clr_counter));
  NAND3X1 g2817(.A (n_293), .B (n_294), .C (n_290), .Y (n_295));
  AOI22X1 g2818(.A (startupWaitReg[2]), .B (n_292), .C (n_287), .D
       (startupWaitReg[3]), .Y (n_294));
  AOI22X1 g2819(.A (startupWaitReg[4]), .B (n_291), .C
       (startupWaitReg[1]), .D (n_289), .Y (n_293));
  INVX1 g2820(.A (startupWaitReg[4]), .Y (n_292));
  DFFSR \startupWaitReg_reg[4] (.R (n_286), .S (1'b1), .CLK (clk), .D
       (startupWaitReg[3]), .Q (startupWaitReg[4]));
  INVX1 g2822(.A (startupWaitReg[3]), .Y (n_291));
  DFFSR \startupWaitReg_reg[3] (.R (n_286), .S (1'b1), .CLK (clk), .D
       (startupWaitReg[2]), .Q (startupWaitReg[3]));
  AOI21X1 g2824(.A (startupWaitReg[0]), .B (n_288), .C
       (clr_counter_reg), .Y (n_290));
  INVX1 g2825(.A (startupWaitReg[2]), .Y (n_289));
  DFFSR \startupWaitReg_reg[2] (.R (n_286), .S (1'b1), .CLK (clk), .D
       (startupWaitReg[1]), .Q (startupWaitReg[2]));
  INVX1 g2827(.A (startupWaitReg[1]), .Y (n_288));
  DFFSR \startupWaitReg_reg[1] (.R (n_286), .S (1'b1), .CLK (clk), .D
       (startupWaitReg[0]), .Q (startupWaitReg[1]));
  INVX1 g2829(.A (startupWaitReg[0]), .Y (n_287));
  DFFSR \startupWaitReg_reg[0] (.R (n_286), .S (1'b1), .CLK (clk), .D
       (1'b1), .Q (startupWaitReg[0]));
  NAND2X1 g2831(.A (en_osc_out), .B (n_285), .Y (stop_osc[0]));
  NAND2X1 g2832(.A (en_osc_out), .B (uut_n_14), .Y (stop_osc[3]));
  NAND3X1 g2833(.A (n_18), .B (px_addr[1]), .C (en_osc_out), .Y
       (stop_osc[2]));
  NAND3X1 g2834(.A (n_283), .B (px_addr[0]), .C (en_osc_out), .Y
       (stop_osc[1]));
  NOR2X1 g2836(.A (rst), .B (n_284), .Y (n_286));
  NOR2X1 g2837(.A (px_addr[1]), .B (px_addr[0]), .Y (n_285));
  NOR2X1 g2838(.A (n_18), .B (n_283), .Y (uut_n_14));
  INVX1 g2839(.A (en_osc_out), .Y (n_284));
  INVX2 g2840(.A (px_addr[1]), .Y (n_283));
  INVX2 g2841(.A (px_addr[0]), .Y (n_18));
  ...
  DFFPOSX1 \px_addr_reg_reg[1] (.CLK (clk), .D (n_201), .Q
       (px_addr[1]));
  DFFPOSX1 \samp_track_reg[0] (.CLK (clk), .D (n_343), .Q
       (samp_track[0]));
  ...
  OR2X2 g6096(.A (n_347), .B (n_112), .Y (n_134));
  ...
  OAI21X1 g6101(.A (n_89), .B (n_80), .C (px_addr[1]), .Y (n_128));
  ...
  INVX1 g6247(.A (sampleOut[28]), .Y (n_17));
  INVX1 g6248(.A (sampleOut[12]), .Y (n_16));
  INVX1 g6249(.A (samp_track[1]), .Y (n_15));
  INVX2 g6250(.A (loadedVal), .Y (n_14));
  INVX1 g6251(.A (samp_track[2]), .Y (n_13));
  INVX1 g6252(.A (sampleOut[20]), .Y (n_12));
  INVX1 g6253(.A (rst), .Y (n_11));
  INVX2 g6254(.A (ack_received), .Y (n_10));
  INVX2 drc_bufs6260(.A (n_6), .Y (n_7));
  INVX2 drc_bufs6261(.A (n_120), .Y (n_6));
  INVX2 drc_bufs6267(.A (n_4), .Y (n_5));
  INVX2 drc_bufs6268(.A (n_110), .Y (n_4));
  INVX2 drc_bufs6274(.A (n_2), .Y (n_3));
  INVX2 drc_bufs6275(.A (n_111), .Y (n_2));
  INVX2 drc_bufs6281(.A (n_0), .Y (n_1));
  INVX2 drc_bufs6282(.A (n_119), .Y (n_0));
  INVX1 g6283(.A (n_27), .Y (n_80));
  MUX2X1 g2(.A (n_95), .B (n_62), .S (samp_track[0]), .Y (n_343));
  NAND3X1 g6284(.A (n_344), .B (n_70), .C (n_88), .Y (n_345));
  NOR2X1 g3(.A (n_73), .B (n_127), .Y (n_344));
  OAI21X1 g6285(.A (n_23), .B (n_40), .C (n_346), .Y (n_347));
  NOR2X1 g6286(.A (n_73), .B (n_74), .Y (n_346));
endmodule
...
module i2cSlaveTop_v8(clk, clk_px, rst, sda, scl, px_addr, stop_osc,
     drdy);
  input clk, rst, scl;
  input [19:0] clk_px;
  output [1:0] px_addr;
  ...
  wire sda;
  wire [31:0] sampleOut;
  wire [7:0] u_i2cSlave_dataFromRegIF;
  wire [4:0] u_i2cSlave_sclDelayed;
  wire [1:0] u_i2cSlave_startStopDetState;
  wire [1:0] u_i2cSlave_regAddr;
  wire [4:0] u_i2cSlave_sdaPipe;
  wire [4:0] u_i2cSlave_sclPipe;
  wire [1:0] u_i2cSlave_rstPipe;
  wire [1:0] u_i2cSlave_sdaDelayed;
  ...
  wire ack_received, clr_counter, counterChip1_n_39, counterChip1_n_41,
       counterChip1_n_43, counterChip1_n_45, counterChip1_n_47,
       counterChip1_n_49;
  wire counterChip1_n_51, counterChip1_n_53, counterChip1_n_55,
       counterChip1_n_57, counterChip1_n_59, counterChip1_n_61,
       counterChip1_n_63, counterChip1_n_65;
  wire counterChip1_n_67, counterChip1_n_69, counterChip1_n_71,
       counterChip1_n_73, counterChip1_n_75, counterChip1_n_77,
       counterChip1_n_79, counterChip1_n_81;
  wire counterChip1_n_83, counterChip1_n_85, counterChip1_n_87,
       counterChip1_n_89, counterChip1_n_91, counterChip1_n_93,
       counterChip1_n_95, counterChip1_n_97;
  wire counterChip1_n_99, counterChip2_n_39, counterChip2_n_41,
       counterChip2_n_43, counterChip2_n_45, counterChip2_n_47,
       counterChip2_n_49, counterChip2_n_51;
  wire counterChip2_n_53, counterChip2_n_55, counterChip2_n_57,
       counterChip2_n_59, counterChip2_n_61, counterChip2_n_63,
       counterChip2_n_65, counterChip2_n_67;
  wire counterChip2_n_69, counterChip2_n_71, counterChip2_n_73,
       counterChip2_n_75, counterChip2_n_77, counterChip2_n_79,
       counterChip2_n_81, counterChip2_n_83;
  wire counterChip2_n_85, counterChip2_n_87, counterChip2_n_89,
       counterChip2_n_91, counterChip2_n_93, counterChip2_n_95,
       counterChip2_n_97, counterChip2_n_99;
  wire counterChip3_n_39, counterChip3_n_41, counterChip3_n_43,
       counterChip3_n_45, counterChip3_n_47, counterChip3_n_49,
       counterChip3_n_51, counterChip3_n_53;
  wire counterChip3_n_55, counterChip3_n_57, counterChip3_n_59,
       counterChip3_n_61, counterChip3_n_63, counterChip3_n_65,
       counterChip3_n_67, counterChip3_n_69;
  wire counterChip3_n_71, counterChip3_n_73, counterChip3_n_75,
       counterChip3_n_77, counterChip3_n_79, counterChip3_n_81,
       counterChip3_n_83, counterChip3_n_85;
  wire counterChip3_n_87, counterChip3_n_89, counterChip3_n_91,
       counterChip3_n_93, counterChip3_n_95, counterChip3_n_97,
       counterChip3_n_99, counterChip4_n_39;
  wire counterChip4_n_41, counterChip4_n_43, counterChip4_n_45,
       counterChip4_n_47, counterChip4_n_49, counterChip4_n_51,
       counterChip4_n_53, counterChip4_n_55;
  wire counterChip4_n_57, counterChip4_n_59, counterChip4_n_61,
       counterChip4_n_63, counterChip4_n_65, counterChip4_n_67,
       counterChip4_n_69, counterChip4_n_71;
  wire counterChip4_n_73, counterChip4_n_75, counterChip4_n_77,
       counterChip4_n_79, counterChip4_n_81, counterChip4_n_83,
       counterChip4_n_85, counterChip4_n_87;
  wire counterChip4_n_89, counterChip4_n_91, counterChip4_n_93,
       counterChip4_n_95, counterChip4_n_97, counterChip4_n_99,
       counterChip5_n_39, counterChip5_n_41;
  wire counterChip5_n_43, counterChip5_n_45, counterChip5_n_47,
       counterChip5_n_49, counterChip5_n_51, counterChip5_n_53,
       counterChip5_n_55, counterChip5_n_57;
  wire counterChip5_n_59, counterChip5_n_61, counterChip5_n_63,
       counterChip5_n_65, counterChip5_n_67, counterChip5_n_69,
       counterChip5_n_71, counterChip5_n_73;
  wire counterChip5_n_75, counterChip5_n_77, counterChip5_n_79,
       counterChip5_n_81, counterChip5_n_83, counterChip5_n_85,
       counterChip5_n_87, counterChip5_n_89;
  wire counterChip5_n_91, counterChip5_n_93, counterChip5_n_95,
       counterChip5_n_97, counterChip5_n_99, \counter_val[0][0] ,
       \counter_val[0][1] , \counter_val[0][2] ;
  wire \counter_val[0][3] , \counter_val[0][4] , \counter_val[0][5] ,
       \counter_val[0][6] , \counter_val[0][7] , \counter_val[0][8] ,
       \counter_val[0][9] , \counter_val[0][10] ;
  wire \counter_val[0][11] , \counter_val[0][12] , \counter_val[0][13]
       , \counter_val[0][14] , \counter_val[0][15] ,
       \counter_val[0][16] , \counter_val[0][17] , \counter_val[0][18] ;
  wire \counter_val[0][19] , \counter_val[0][20] , \counter_val[0][21]
       , \counter_val[0][22] , \counter_val[0][23] ,
       \counter_val[0][24] , \counter_val[0][25] , \counter_val[0][26] ;
  wire \counter_val[0][27] , \counter_val[0][28] , \counter_val[0][29]
       , \counter_val[0][30] , \counter_val[0][31] , \counter_val[1][0]
       , \counter_val[1][1] , \counter_val[1][2] ;
  wire \counter_val[1][3] , \counter_val[1][4] , \counter_val[1][5] ,
       \counter_val[1][6] , \counter_val[1][7] , \counter_val[1][8] ,
       \counter_val[1][9] , \counter_val[1][10] ;
  wire \counter_val[1][11] , \counter_val[1][12] , \counter_val[1][13]
       , \counter_val[1][14] , \counter_val[1][15] ,
       \counter_val[1][16] , \counter_val[1][17] , \counter_val[1][18] ;
  wire \counter_val[1][19] , \counter_val[1][20] , \counter_val[1][21]
       , \counter_val[1][22] , \counter_val[1][23] ,
       \counter_val[1][24] , \counter_val[1][25] , \counter_val[1][26] ;
  wire \counter_val[1][27] , \counter_val[1][28] , \counter_val[1][29]
       , \counter_val[1][30] , \counter_val[1][31] , \counter_val[2][0]
       , \counter_val[2][1] , \counter_val[2][2] ;
  wire \counter_val[2][3] , \counter_val[2][4] , \counter_val[2][5] ,
       \counter_val[2][6] , \counter_val[2][7] , \counter_val[2][8] ,
       \counter_val[2][9] , \counter_val[2][10] ;
  wire \counter_val[2][11] , \counter_val[2][12] , \counter_val[2][13]
       , \counter_val[2][14] , \counter_val[2][15] ,
       \counter_val[2][16] , \counter_val[2][17] , \counter_val[2][18] ;
  wire \counter_val[2][19] , \counter_val[2][20] , \counter_val[2][21]
       , \counter_val[2][22] , \counter_val[2][23] ,
       \counter_val[2][24] , \counter_val[2][25] , \counter_val[2][26] ;
  wire \counter_val[2][27] , \counter_val[2][28] , \counter_val[2][29]
       , \counter_val[2][30] , \counter_val[2][31] , \counter_val[3][0]
       , \counter_val[3][1] , \counter_val[3][2] ;
  wire \counter_val[3][3] , \counter_val[3][4] , \counter_val[3][5] ,
       \counter_val[3][6] , \counter_val[3][7] , \counter_val[3][8] ,
       \counter_val[3][9] , \counter_val[3][10] ;
  wire \counter_val[3][11] , \counter_val[3][12] , \counter_val[3][13]
       , \counter_val[3][14] , \counter_val[3][15] ,
       \counter_val[3][16] , \counter_val[3][17] , \counter_val[3][18] ;
  wire \counter_val[3][19] , \counter_val[3][20] , \counter_val[3][21]
       , \counter_val[3][22] , \counter_val[3][23] ,
       \counter_val[3][24] , \counter_val[3][25] , \counter_val[3][26] ;
  wire \counter_val[3][27] , \counter_val[3][28] , \counter_val[3][29]
       , \counter_val[3][30] , \counter_val[3][31] , \counter_val[4][0]
       , \counter_val[4][1] , \counter_val[4][2] ;
  wire \counter_val[4][3] , \counter_val[4][4] , \counter_val[4][5] ,
       \counter_val[4][6] , \counter_val[4][7] , \counter_val[4][8] ,
       \counter_val[4][9] , \counter_val[4][10] ;
  wire \counter_val[4][11] , \counter_val[4][12] , \counter_val[4][13]
       , \counter_val[4][14] , \counter_val[4][15] ,
       \counter_val[4][16] , \counter_val[4][17] , \counter_val[4][18] ;
  wire \counter_val[4][19] , \counter_val[4][20] , \counter_val[4][21]
       , \counter_val[4][22] , \counter_val[4][23] ,
       \counter_val[4][24] , \counter_val[4][25] , \counter_val[4][26] ;
  wire \counter_val[4][27] , \counter_val[4][28] , \counter_val[4][29]
       , \counter_val[4][30] , \counter_val[4][31] , en_osc_out, n_1,
       n_2;
  ...
  wire n_60, n_63, n_64, n_65, n_66, n_67, n_70, n_71;
  ...
  wire n_97, n_98, n_99, n_100, n_101, n_102, n_103, n_104;
  wire n_105, n_106, n_107, n_141, n_142, n_143, n_144, n_145;
  wire u_i2cSlave_clearStartStopDet, u_i2cSlave_n_144,
       u_i2cSlave_n_259, u_i2cSlave_sclDeb, u_i2cSlave_sdaDeb,
       u_i2cSlave_sdaOut, u_i2cSlave_startEdgeDet;
  assign stop_osc[4] = 1'b1;
  increment_unsigned_53_54_442 counterChip1_inc_add_34_11_2(.A
       ({\counter_val[0][31] , \counter_val[0][30] ,
       \counter_val[0][29] , \counter_val[0][28] , \counter_val[0][27]
       , \counter_val[0][26] , \counter_val[0][25] ,
       \counter_val[0][24] , \counter_val[0][23] , \counter_val[0][22]
       , \counter_val[0][21] , \counter_val[0][20] ,
       \counter_val[0][19] , \counter_val[0][18] , \counter_val[0][17]
       , \counter_val[0][16] , \counter_val[0][15] ,
       \counter_val[0][14] , \counter_val[0][13] , \counter_val[0][12]
       , \counter_val[0][11] , \counter_val[0][10] , \counter_val[0][9]
       , \counter_val[0][8] , \counter_val[0][7] , \counter_val[0][6] ,
       \counter_val[0][5] , \counter_val[0][4] , \counter_val[0][3] ,
       \counter_val[0][2] , \counter_val[0][1] , \counter_val[0][0] }),
       .CI (1'b1), .Z ({counterChip1_n_99, counterChip1_n_97,
       counterChip1_n_95, counterChip1_n_93, counterChip1_n_91,
       counterChip1_n_89, counterChip1_n_87, counterChip1_n_85,
       counterChip1_n_83, counterChip1_n_81, counterChip1_n_79,
       counterChip1_n_77, counterChip1_n_75, counterChip1_n_73,
       counterChip1_n_71, counterChip1_n_69, counterChip1_n_67,
       counterChip1_n_65, counterChip1_n_63, counterChip1_n_61,
       counterChip1_n_59, counterChip1_n_57, counterChip1_n_55,
       counterChip1_n_53, counterChip1_n_51, counterChip1_n_49,
       counterChip1_n_47, counterChip1_n_45, counterChip1_n_43,
       counterChip1_n_41, counterChip1_n_39, UNCONNECTED0}));
  increment_unsigned_53_54_443 counterChip2_inc_add_34_11_2(.A
       ({\counter_val[1][31] , \counter_val[1][30] ,
       \counter_val[1][29] , \counter_val[1][28] , \counter_val[1][27]
       , \counter_val[1][26] , \counter_val[1][25] ,
       \counter_val[1][24] , \counter_val[1][23] , \counter_val[1][22]
       , \counter_val[1][21] , \counter_val[1][20] ,
       \counter_val[1][19] , \counter_val[1][18] , \counter_val[1][17]
       , \counter_val[1][16] , \counter_val[1][15] ,
       \counter_val[1][14] , \counter_val[1][13] , \counter_val[1][12]
       , \counter_val[1][11] , \counter_val[1][10] , \counter_val[1][9]
       , \counter_val[1][8] , \counter_val[1][7] , \counter_val[1][6] ,
       \counter_val[1][5] , \counter_val[1][4] , \counter_val[1][3] ,
       \counter_val[1][2] , \counter_val[1][1] , \counter_val[1][0] }),
       .CI (1'b1), .Z ({counterChip2_n_99, counterChip2_n_97,
       counterChip2_n_95, counterChip2_n_93, counterChip2_n_91,
       counterChip2_n_89, counterChip2_n_87, counterChip2_n_85,
       counterChip2_n_83, counterChip2_n_81, counterChip2_n_79,
       counterChip2_n_77, counterChip2_n_75, counterChip2_n_73,
       counterChip2_n_71, counterChip2_n_69, counterChip2_n_67,
       counterChip2_n_65, counterChip2_n_63, counterChip2_n_61,
       counterChip2_n_59, counterChip2_n_57, counterChip2_n_55,
       counterChip2_n_53, counterChip2_n_51, counterChip2_n_49,
       counterChip2_n_47, counterChip2_n_45, counterChip2_n_43,
       counterChip2_n_41, counterChip2_n_39, UNCONNECTED1}));
  increment_unsigned_53_54_444 counterChip3_inc_add_34_11_2(.A
       ({\counter_val[2][31] , \counter_val[2][30] ,
       \counter_val[2][29] , \counter_val[2][28] , \counter_val[2][27]
       , \counter_val[2][26] , \counter_val[2][25] ,
       \counter_val[2][24] , \counter_val[2][23] , \counter_val[2][22]
       , \counter_val[2][21] , \counter_val[2][20] ,
       \counter_val[2][19] , \counter_val[2][18] , \counter_val[2][17]
       , \counter_val[2][16] , \counter_val[2][15] ,
       \counter_val[2][14] , \counter_val[2][13] , \counter_val[2][12]
       , \counter_val[2][11] , \counter_val[2][10] , \counter_val[2][9]
       , \counter_val[2][8] , \counter_val[2][7] , \counter_val[2][6] ,
       \counter_val[2][5] , \counter_val[2][4] , \counter_val[2][3] ,
       \counter_val[2][2] , \counter_val[2][1] , \counter_val[2][0] }),
       .CI (1'b1), .Z ({counterChip3_n_99, counterChip3_n_97,
       counterChip3_n_95, counterChip3_n_93, counterChip3_n_91,
       counterChip3_n_89, counterChip3_n_87, counterChip3_n_85,
       counterChip3_n_83, counterChip3_n_81, counterChip3_n_79,
       counterChip3_n_77, counterChip3_n_75, counterChip3_n_73,
       counterChip3_n_71, counterChip3_n_69, counterChip3_n_67,
       counterChip3_n_65, counterChip3_n_63, counterChip3_n_61,
       counterChip3_n_59, counterChip3_n_57, counterChip3_n_55,
       counterChip3_n_53, counterChip3_n_51, counterChip3_n_49,
       counterChip3_n_47, counterChip3_n_45, counterChip3_n_43,
       counterChip3_n_41, counterChip3_n_39, UNCONNECTED2}));
  increment_unsigned_53_54_445 counterChip4_inc_add_34_11_2(.A
       ({\counter_val[3][31] , \counter_val[3][30] ,
       \counter_val[3][29] , \counter_val[3][28] , \counter_val[3][27]
       , \counter_val[3][26] , \counter_val[3][25] ,
       \counter_val[3][24] , \counter_val[3][23] , \counter_val[3][22]
       , \counter_val[3][21] , \counter_val[3][20] ,
       \counter_val[3][19] , \counter_val[3][18] , \counter_val[3][17]
       , \counter_val[3][16] , \counter_val[3][15] ,
       \counter_val[3][14] , \counter_val[3][13] , \counter_val[3][12]
       , \counter_val[3][11] , \counter_val[3][10] , \counter_val[3][9]
       , \counter_val[3][8] , \counter_val[3][7] , \counter_val[3][6] ,
       \counter_val[3][5] , \counter_val[3][4] , \counter_val[3][3] ,
       \counter_val[3][2] , \counter_val[3][1] , \counter_val[3][0] }),
       .CI (1'b1), .Z ({counterChip4_n_99, counterChip4_n_97,
       counterChip4_n_95, counterChip4_n_93, counterChip4_n_91,
       counterChip4_n_89, counterChip4_n_87, counterChip4_n_85,
       counterChip4_n_83, counterChip4_n_81, counterChip4_n_79,
       counterChip4_n_77, counterChip4_n_75, counterChip4_n_73,
       counterChip4_n_71, counterChip4_n_69, counterChip4_n_67,
       counterChip4_n_65, counterChip4_n_63, counterChip4_n_61,
       counterChip4_n_59, counterChip4_n_57, counterChip4_n_55,
       counterChip4_n_53, counterChip4_n_51, counterChip4_n_49,
       counterChip4_n_47, counterChip4_n_45, counterChip4_n_43,
       counterChip4_n_41, counterChip4_n_39, UNCONNECTED3}));
  increment_unsigned_53_54 counterChip5_inc_add_34_11_2(.A
       ({\counter_val[4][31] , \counter_val[4][30] ,
       \counter_val[4][29] , \counter_val[4][28] , \counter_val[4][27]
       , \counter_val[4][26] , \counter_val[4][25] ,
       \counter_val[4][24] , \counter_val[4][23] , \counter_val[4][22]
       , \counter_val[4][21] , \counter_val[4][20] ,
       \counter_val[4][19] , \counter_val[4][18] , \counter_val[4][17]
       , \counter_val[4][16] , \counter_val[4][15] ,
       \counter_val[4][14] , \counter_val[4][13] , \counter_val[4][12]
       , \counter_val[4][11] , \counter_val[4][10] , \counter_val[4][9]
       , \counter_val[4][8] , \counter_val[4][7] , \counter_val[4][6] ,
       \counter_val[4][5] , \counter_val[4][4] , \counter_val[4][3] ,
       \counter_val[4][2] , \counter_val[4][1] , \counter_val[4][0] }),
       .CI (1'b1), .Z ({counterChip5_n_99, counterChip5_n_97,
       counterChip5_n_95, counterChip5_n_93, counterChip5_n_91,
       counterChip5_n_89, counterChip5_n_87, counterChip5_n_85,
       counterChip5_n_83, counterChip5_n_81, counterChip5_n_79,
       counterChip5_n_77, counterChip5_n_75, counterChip5_n_73,
       counterChip5_n_71, counterChip5_n_69, counterChip5_n_67,
       counterChip5_n_65, counterChip5_n_63, counterChip5_n_61,
       counterChip5_n_59, counterChip5_n_57, counterChip5_n_55,
       counterChip5_n_53, counterChip5_n_51, counterChip5_n_49,
       counterChip5_n_47, counterChip5_n_45, counterChip5_n_43,
       counterChip5_n_41, counterChip5_n_39, UNCONNECTED4}));
  chipBusController_p4 logicUnit(.clk (clk), .rst (rst), .counter_val1
       ({\counter_val[0][31] , \counter_val[0][30] ,
       \counter_val[0][29] , \counter_val[0][28] , \counter_val[0][27]
       , \counter_val[0][26] , \counter_val[0][25] ,
       \counter_val[0][24] , \counter_val[0][23] , \counter_val[0][22]
       ...
       \counter_val[0][5] , \counter_val[0][4] , \counter_val[0][3] ,
       \counter_val[0][2] , \counter_val[0][1] , \counter_val[0][0] }),
       .counter_val2 ({\counter_val[1][31] , \counter_val[1][30] ,
       \counter_val[1][29] , \counter_val[1][28] , \counter_val[1][27]
       , \counter_val[1][26] , \counter_val[1][25] ,
       \counter_val[1][24] , \counter_val[1][23] , \counter_val[1][22]
       , \counter_val[1][21] , \counter_val[1][20] ,
       ...
       \counter_val[1][5] , \counter_val[1][4] , \counter_val[1][3] ,
       \counter_val[1][2] , \counter_val[1][1] , \counter_val[1][0] }),
       .counter_val3 ({\counter_val[2][31] , \counter_val[2][30] ,
       \counter_val[2][29] , \counter_val[2][28] , \counter_val[2][27]
       , \counter_val[2][26] , \counter_val[2][25] ,
       \counter_val[2][24] , \counter_val[2][23] , \counter_val[2][22]
       , \counter_val[2][21] , \counter_val[2][20] ,
       ...
       \counter_val[2][5] , \counter_val[2][4] , \counter_val[2][3] ,
       \counter_val[2][2] , \counter_val[2][1] , \counter_val[2][0] }),
       .counter_val4 ({\counter_val[3][31] , \counter_val[3][30] ,
       \counter_val[3][29] , \counter_val[3][28] , \counter_val[3][27]
       , \counter_val[3][26] , \counter_val[3][25] ,
       \counter_val[3][24] , \counter_val[3][23] , \counter_val[3][22]
       , \counter_val[3][21] , \counter_val[3][20] ,
       ...
       \counter_val[3][5] , \counter_val[3][4] , \counter_val[3][3] ,
       \counter_val[3][2] , \counter_val[3][1] , \counter_val[3][0] }),
       .counter_val5 ({\counter_val[4][31] , \counter_val[4][30] ,
       \counter_val[4][29] , \counter_val[4][28] , \counter_val[4][27]
       , \counter_val[4][26] , \counter_val[4][25] ,
       \counter_val[4][24] , \counter_val[4][23] , \counter_val[4][22]
       , \counter_val[4][21] , \counter_val[4][20] ,
       ...
       \counter_val[4][5] , \counter_val[4][4] , \counter_val[4][3] ,
       \counter_val[4][2] , \counter_val[4][1] , \counter_val[4][0] }),
       .px_addr (px_addr), .stop_osc ({UNCONNECTED5, stop_osc[3:0]}),
       .clr_counter (clr_counter), .drdy (drdy), .sampleOut
       (sampleOut), .ack_received (ack_received), .en_osc_out
       (en_osc_out));
  serialInterface_v2 u_i2cSlave_u_serialInterface(.clearStartStopDet
       (u_i2cSlave_clearStartStopDet), .clk (clk), .dataIn
       (u_i2cSlave_dataFromRegIF), .dataOut ({UNCONNECTED13,
       UNCONNECTED12, UNCONNECTED11, UNCONNECTED10, UNCONNECTED9,
       UNCONNECTED8, UNCONNECTED7, UNCONNECTED6}), .regAddr
       (u_i2cSlave_regAddr), .rst (u_i2cSlave_n_144), .scl
       (u_i2cSlave_sclDelayed[4]), .sdaIn (u_i2cSlave_sdaDeb), .sdaOut
       (u_i2cSlave_sdaOut), .startStopDetState ({ack_received,
       u_i2cSlave_startStopDetState[0]}), .writeEn (UNCONNECTED14),
       .ack_received (UNCONNECTED15), .statusLED (u_i2cSlave_n_259));
  INVX1 g372(.A (clr_counter), .Y (n_107));
  DFFSR \counterChip1_q_reg[0] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (n_80), .Q (\counter_val[0][0] ));
  DFFSR \counterChip1_q_reg[10] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_57), .Q (\counter_val[0][10] ));
  DFFSR \counterChip1_q_reg[11] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_59), .Q (\counter_val[0][11] ));
  DFFSR \counterChip1_q_reg[12] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_61), .Q (\counter_val[0][12] ));
  DFFSR \counterChip1_q_reg[13] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_63), .Q (\counter_val[0][13] ));
  DFFSR \counterChip1_q_reg[14] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_65), .Q (\counter_val[0][14] ));
  DFFSR \counterChip1_q_reg[15] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_67), .Q (\counter_val[0][15] ));
  DFFSR \counterChip1_q_reg[16] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_69), .Q (\counter_val[0][16] ));
  DFFSR \counterChip1_q_reg[17] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_71), .Q (\counter_val[0][17] ));
  DFFSR \counterChip1_q_reg[18] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_73), .Q (\counter_val[0][18] ));
  DFFSR \counterChip1_q_reg[19] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_75), .Q (\counter_val[0][19] ));
  DFFSR \counterChip1_q_reg[1] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_39), .Q (\counter_val[0][1] ));
  DFFSR \counterChip1_q_reg[20] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_77), .Q (\counter_val[0][20] ));
  DFFSR \counterChip1_q_reg[21] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_79), .Q (\counter_val[0][21] ));
  DFFSR \counterChip1_q_reg[22] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_81), .Q (\counter_val[0][22] ));
  DFFSR \counterChip1_q_reg[23] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_83), .Q (\counter_val[0][23] ));
  DFFSR \counterChip1_q_reg[24] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_85), .Q (\counter_val[0][24] ));
  DFFSR \counterChip1_q_reg[25] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_87), .Q (\counter_val[0][25] ));
  DFFSR \counterChip1_q_reg[26] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_89), .Q (\counter_val[0][26] ));
  DFFSR \counterChip1_q_reg[27] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_91), .Q (\counter_val[0][27] ));
  DFFSR \counterChip1_q_reg[28] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_93), .Q (\counter_val[0][28] ));
  DFFSR \counterChip1_q_reg[29] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_95), .Q (\counter_val[0][29] ));
  DFFSR \counterChip1_q_reg[2] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_41), .Q (\counter_val[0][2] ));
  DFFSR \counterChip1_q_reg[30] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_97), .Q (\counter_val[0][30] ));
  DFFSR \counterChip1_q_reg[31] (.R (n_107), .S (1'b1), .CLK (n_106),
       .D (counterChip1_n_99), .Q (\counter_val[0][31] ));
  DFFSR \counterChip1_q_reg[3] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_43), .Q (\counter_val[0][3] ));
  DFFSR \counterChip1_q_reg[4] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_45), .Q (\counter_val[0][4] ));
  DFFSR \counterChip1_q_reg[5] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_47), .Q (\counter_val[0][5] ));
  DFFSR \counterChip1_q_reg[6] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_49), .Q (\counter_val[0][6] ));
  DFFSR \counterChip1_q_reg[7] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_51), .Q (\counter_val[0][7] ));
  DFFSR \counterChip1_q_reg[8] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_53), .Q (\counter_val[0][8] ));
  DFFSR \counterChip1_q_reg[9] (.R (n_107), .S (1'b1), .CLK (n_106), .D
       (counterChip1_n_55), .Q (\counter_val[0][9] ));
  DFFSR \counterChip2_q_reg[0] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (n_82), .Q (\counter_val[1][0] ));
  DFFSR \counterChip2_q_reg[10] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_57), .Q (\counter_val[1][10] ));
  DFFSR \counterChip2_q_reg[11] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_59), .Q (\counter_val[1][11] ));
  DFFSR \counterChip2_q_reg[12] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_61), .Q (\counter_val[1][12] ));
  DFFSR \counterChip2_q_reg[13] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_63), .Q (\counter_val[1][13] ));
  DFFSR \counterChip2_q_reg[14] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_65), .Q (\counter_val[1][14] ));
  DFFSR \counterChip2_q_reg[15] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_67), .Q (\counter_val[1][15] ));
  DFFSR \counterChip2_q_reg[16] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_69), .Q (\counter_val[1][16] ));
  DFFSR \counterChip2_q_reg[17] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_71), .Q (\counter_val[1][17] ));
  DFFSR \counterChip2_q_reg[18] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_73), .Q (\counter_val[1][18] ));
  DFFSR \counterChip2_q_reg[19] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_75), .Q (\counter_val[1][19] ));
  DFFSR \counterChip2_q_reg[1] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_39), .Q (\counter_val[1][1] ));
  DFFSR \counterChip2_q_reg[20] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_77), .Q (\counter_val[1][20] ));
  DFFSR \counterChip2_q_reg[21] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_79), .Q (\counter_val[1][21] ));
  DFFSR \counterChip2_q_reg[22] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_81), .Q (\counter_val[1][22] ));
  DFFSR \counterChip2_q_reg[23] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_83), .Q (\counter_val[1][23] ));
  DFFSR \counterChip2_q_reg[24] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_85), .Q (\counter_val[1][24] ));
  DFFSR \counterChip2_q_reg[25] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_87), .Q (\counter_val[1][25] ));
  DFFSR \counterChip2_q_reg[26] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_89), .Q (\counter_val[1][26] ));
  DFFSR \counterChip2_q_reg[27] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_91), .Q (\counter_val[1][27] ));
  DFFSR \counterChip2_q_reg[28] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_93), .Q (\counter_val[1][28] ));
  DFFSR \counterChip2_q_reg[29] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_95), .Q (\counter_val[1][29] ));
  DFFSR \counterChip2_q_reg[2] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_41), .Q (\counter_val[1][2] ));
  DFFSR \counterChip2_q_reg[30] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_97), .Q (\counter_val[1][30] ));
  DFFSR \counterChip2_q_reg[31] (.R (n_107), .S (1'b1), .CLK (n_103),
       .D (counterChip2_n_99), .Q (\counter_val[1][31] ));
  DFFSR \counterChip2_q_reg[3] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_43), .Q (\counter_val[1][3] ));
  DFFSR \counterChip2_q_reg[4] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_45), .Q (\counter_val[1][4] ));
  DFFSR \counterChip2_q_reg[5] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_47), .Q (\counter_val[1][5] ));
  DFFSR \counterChip2_q_reg[6] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_49), .Q (\counter_val[1][6] ));
  DFFSR \counterChip2_q_reg[7] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_51), .Q (\counter_val[1][7] ));
  DFFSR \counterChip2_q_reg[8] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_53), .Q (\counter_val[1][8] ));
  DFFSR \counterChip2_q_reg[9] (.R (n_107), .S (1'b1), .CLK (n_103), .D
       (counterChip2_n_55), .Q (\counter_val[1][9] ));
  DFFSR \counterChip3_q_reg[0] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (n_79), .Q (\counter_val[2][0] ));
  DFFSR \counterChip3_q_reg[10] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_57), .Q (\counter_val[2][10] ));
  DFFSR \counterChip3_q_reg[11] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_59), .Q (\counter_val[2][11] ));
  DFFSR \counterChip3_q_reg[12] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_61), .Q (\counter_val[2][12] ));
  DFFSR \counterChip3_q_reg[13] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_63), .Q (\counter_val[2][13] ));
  DFFSR \counterChip3_q_reg[14] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_65), .Q (\counter_val[2][14] ));
  DFFSR \counterChip3_q_reg[15] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_67), .Q (\counter_val[2][15] ));
  DFFSR \counterChip3_q_reg[16] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_69), .Q (\counter_val[2][16] ));
  DFFSR \counterChip3_q_reg[17] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_71), .Q (\counter_val[2][17] ));
  DFFSR \counterChip3_q_reg[18] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_73), .Q (\counter_val[2][18] ));
  DFFSR \counterChip3_q_reg[19] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_75), .Q (\counter_val[2][19] ));
  DFFSR \counterChip3_q_reg[1] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_39), .Q (\counter_val[2][1] ));
  DFFSR \counterChip3_q_reg[20] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_77), .Q (\counter_val[2][20] ));
  DFFSR \counterChip3_q_reg[21] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_79), .Q (\counter_val[2][21] ));
  DFFSR \counterChip3_q_reg[22] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_81), .Q (\counter_val[2][22] ));
  DFFSR \counterChip3_q_reg[23] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_83), .Q (\counter_val[2][23] ));
  DFFSR \counterChip3_q_reg[24] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_85), .Q (\counter_val[2][24] ));
  DFFSR \counterChip3_q_reg[25] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_87), .Q (\counter_val[2][25] ));
  DFFSR \counterChip3_q_reg[26] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_89), .Q (\counter_val[2][26] ));
  DFFSR \counterChip3_q_reg[27] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_91), .Q (\counter_val[2][27] ));
  DFFSR \counterChip3_q_reg[28] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_93), .Q (\counter_val[2][28] ));
  DFFSR \counterChip3_q_reg[29] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_95), .Q (\counter_val[2][29] ));
  DFFSR \counterChip3_q_reg[2] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_41), .Q (\counter_val[2][2] ));
  DFFSR \counterChip3_q_reg[30] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_97), .Q (\counter_val[2][30] ));
  DFFSR \counterChip3_q_reg[31] (.R (n_107), .S (1'b1), .CLK (n_102),
       .D (counterChip3_n_99), .Q (\counter_val[2][31] ));
  DFFSR \counterChip3_q_reg[3] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_43), .Q (\counter_val[2][3] ));
  DFFSR \counterChip3_q_reg[4] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_45), .Q (\counter_val[2][4] ));
  DFFSR \counterChip3_q_reg[5] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_47), .Q (\counter_val[2][5] ));
  DFFSR \counterChip3_q_reg[6] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_49), .Q (\counter_val[2][6] ));
  DFFSR \counterChip3_q_reg[7] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_51), .Q (\counter_val[2][7] ));
  DFFSR \counterChip3_q_reg[8] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_53), .Q (\counter_val[2][8] ));
  DFFSR \counterChip3_q_reg[9] (.R (n_107), .S (1'b1), .CLK (n_102), .D
       (counterChip3_n_55), .Q (\counter_val[2][9] ));
  DFFSR \counterChip4_q_reg[0] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (n_83), .Q (\counter_val[3][0] ));
  DFFSR \counterChip4_q_reg[10] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_57), .Q (\counter_val[3][10] ));
  DFFSR \counterChip4_q_reg[11] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_59), .Q (\counter_val[3][11] ));
  DFFSR \counterChip4_q_reg[12] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_61), .Q (\counter_val[3][12] ));
  DFFSR \counterChip4_q_reg[13] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_63), .Q (\counter_val[3][13] ));
  DFFSR \counterChip4_q_reg[14] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_65), .Q (\counter_val[3][14] ));
  DFFSR \counterChip4_q_reg[15] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_67), .Q (\counter_val[3][15] ));
  DFFSR \counterChip4_q_reg[16] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_69), .Q (\counter_val[3][16] ));
  DFFSR \counterChip4_q_reg[17] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_71), .Q (\counter_val[3][17] ));
  DFFSR \counterChip4_q_reg[18] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_73), .Q (\counter_val[3][18] ));
  DFFSR \counterChip4_q_reg[19] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_75), .Q (\counter_val[3][19] ));
  DFFSR \counterChip4_q_reg[1] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_39), .Q (\counter_val[3][1] ));
  DFFSR \counterChip4_q_reg[20] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_77), .Q (\counter_val[3][20] ));
  DFFSR \counterChip4_q_reg[21] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_79), .Q (\counter_val[3][21] ));
  DFFSR \counterChip4_q_reg[22] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_81), .Q (\counter_val[3][22] ));
  DFFSR \counterChip4_q_reg[23] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_83), .Q (\counter_val[3][23] ));
  DFFSR \counterChip4_q_reg[24] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_85), .Q (\counter_val[3][24] ));
  DFFSR \counterChip4_q_reg[25] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_87), .Q (\counter_val[3][25] ));
  DFFSR \counterChip4_q_reg[26] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_89), .Q (\counter_val[3][26] ));
  DFFSR \counterChip4_q_reg[27] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_91), .Q (\counter_val[3][27] ));
  DFFSR \counterChip4_q_reg[28] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_93), .Q (\counter_val[3][28] ));
  DFFSR \counterChip4_q_reg[29] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_95), .Q (\counter_val[3][29] ));
  DFFSR \counterChip4_q_reg[2] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_41), .Q (\counter_val[3][2] ));
  DFFSR \counterChip4_q_reg[30] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_97), .Q (\counter_val[3][30] ));
  DFFSR \counterChip4_q_reg[31] (.R (n_107), .S (1'b1), .CLK (n_104),
       .D (counterChip4_n_99), .Q (\counter_val[3][31] ));
  DFFSR \counterChip4_q_reg[3] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_43), .Q (\counter_val[3][3] ));
  DFFSR \counterChip4_q_reg[4] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_45), .Q (\counter_val[3][4] ));
  DFFSR \counterChip4_q_reg[5] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_47), .Q (\counter_val[3][5] ));
  DFFSR \counterChip4_q_reg[6] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_49), .Q (\counter_val[3][6] ));
  DFFSR \counterChip4_q_reg[7] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_51), .Q (\counter_val[3][7] ));
  DFFSR \counterChip4_q_reg[8] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_53), .Q (\counter_val[3][8] ));
  DFFSR \counterChip4_q_reg[9] (.R (n_107), .S (1'b1), .CLK (n_104), .D
       (counterChip4_n_55), .Q (\counter_val[3][9] ));
  DFFSR \counterChip5_q_reg[0] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (n_81), .Q (\counter_val[4][0] ));
  DFFSR \counterChip5_q_reg[10] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_57), .Q (\counter_val[4][10] ));
  DFFSR \counterChip5_q_reg[11] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_59), .Q (\counter_val[4][11] ));
  DFFSR \counterChip5_q_reg[12] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_61), .Q (\counter_val[4][12] ));
  DFFSR \counterChip5_q_reg[13] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_63), .Q (\counter_val[4][13] ));
  DFFSR \counterChip5_q_reg[14] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_65), .Q (\counter_val[4][14] ));
  DFFSR \counterChip5_q_reg[15] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_67), .Q (\counter_val[4][15] ));
  DFFSR \counterChip5_q_reg[16] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_69), .Q (\counter_val[4][16] ));
  DFFSR \counterChip5_q_reg[17] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_71), .Q (\counter_val[4][17] ));
  DFFSR \counterChip5_q_reg[18] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_73), .Q (\counter_val[4][18] ));
  DFFSR \counterChip5_q_reg[19] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_75), .Q (\counter_val[4][19] ));
  DFFSR \counterChip5_q_reg[1] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_39), .Q (\counter_val[4][1] ));
  DFFSR \counterChip5_q_reg[20] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_77), .Q (\counter_val[4][20] ));
  DFFSR \counterChip5_q_reg[21] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_79), .Q (\counter_val[4][21] ));
  DFFSR \counterChip5_q_reg[22] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_81), .Q (\counter_val[4][22] ));
  DFFSR \counterChip5_q_reg[23] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_83), .Q (\counter_val[4][23] ));
  DFFSR \counterChip5_q_reg[24] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_85), .Q (\counter_val[4][24] ));
  DFFSR \counterChip5_q_reg[25] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_87), .Q (\counter_val[4][25] ));
  DFFSR \counterChip5_q_reg[26] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_89), .Q (\counter_val[4][26] ));
  DFFSR \counterChip5_q_reg[27] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_91), .Q (\counter_val[4][27] ));
  DFFSR \counterChip5_q_reg[28] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_93), .Q (\counter_val[4][28] ));
  DFFSR \counterChip5_q_reg[29] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_95), .Q (\counter_val[4][29] ));
  DFFSR \counterChip5_q_reg[2] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_41), .Q (\counter_val[4][2] ));
  DFFSR \counterChip5_q_reg[30] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_97), .Q (\counter_val[4][30] ));
  DFFSR \counterChip5_q_reg[31] (.R (n_107), .S (1'b1), .CLK (n_105),
       .D (counterChip5_n_99), .Q (\counter_val[4][31] ));
  DFFSR \counterChip5_q_reg[3] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_43), .Q (\counter_val[4][3] ));
  DFFSR \counterChip5_q_reg[4] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_45), .Q (\counter_val[4][4] ));
  DFFSR \counterChip5_q_reg[5] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_47), .Q (\counter_val[4][5] ));
  DFFSR \counterChip5_q_reg[6] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_49), .Q (\counter_val[4][6] ));
  DFFSR \counterChip5_q_reg[7] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_51), .Q (\counter_val[4][7] ));
  DFFSR \counterChip5_q_reg[8] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_53), .Q (\counter_val[4][8] ));
  DFFSR \counterChip5_q_reg[9] (.R (n_107), .S (1'b1), .CLK (n_105), .D
       (counterChip5_n_55), .Q (\counter_val[4][9] ));
  NAND2X1 g811(.A (n_101), .B (n_100), .Y (n_106));
  NAND2X1 g812(.A (n_92), .B (n_93), .Y (n_105));
  NAND2X1 g813(.A (n_98), .B (n_99), .Y (n_103));
  NAND2X1 g814(.A (n_97), .B (n_96), .Y (n_102));
  NAND2X1 g815(.A (n_95), .B (n_94), .Y (n_104));
  ...
  AOI22X1 g824(.A (clk_px[16]), .B (n_88), .C (clk_px[18]), .D (n_90),
       .Y (n_93));
  AOI22X1 g825(.A (clk_px[17]), .B (n_89), .C (clk_px[19]), .D (n_91),
       .Y (n_92));
  AND2X2 g826(.A (n_85), .B (px_addr[0]), .Y (n_91));
  NOR2X1 g827(.A (px_addr[0]), .B (n_84), .Y (n_90));
  AND2X2 g828(.A (n_86), .B (px_addr[0]), .Y (n_89));
  NOR2X1 g829(.A (px_addr[0]), .B (n_87), .Y (n_88));
  INVX2 g830(.A (n_86), .Y (n_87));
  NOR2X1 g831(.A (px_addr[1]), .B (n_78), .Y (n_86));
  INVX1 g832(.A (n_84), .Y (n_85));
  NAND2X1 g833(.A (px_addr[1]), .B (en_osc_out), .Y (n_84));
  INVX1 g834(.A (\counter_val[3][0] ), .Y (n_83));
  INVX1 g835(.A (\counter_val[1][0] ), .Y (n_82));
  INVX1 g836(.A (\counter_val[4][0] ), .Y (n_81));
  INVX1 g837(.A (\counter_val[0][0] ), .Y (n_80));
  INVX1 g838(.A (\counter_val[2][0] ), .Y (n_79));
  INVX2 g839(.A (en_osc_out), .Y (n_78));
  DFFPOSX1 u_i2cSlave_sdaDeb_reg(.CLK (clk), .D (n_75), .Q
       (u_i2cSlave_sdaDeb));
  DFFPOSX1 u_i2cSlave_sclDeb_reg(.CLK (clk), .D (n_76), .Q
       (u_i2cSlave_sclDeb));
  NAND3X1 g451(.A (n_73), .B (n_141), .C (n_143), .Y (n_76));
  NAND3X1 g453(.A (n_74), .B (n_144), .C (n_142), .Y (n_75));
  INVX2 g459(.A (n_72), .Y (n_74));
  INVX2 g464(.A (n_71), .Y (n_73));
  OAI21X1 g460(.A (n_67), .B (n_59), .C (n_70), .Y (n_72));
  OAI21X1 g465(.A (n_66), .B (n_58), .C (n_70), .Y (n_71));
  NAND2X1 g470(.A (u_i2cSlave_sdaPipe[4]), .B (u_i2cSlave_sdaPipe[3]),
       .Y (n_67));
  NAND2X1 g477(.A (u_i2cSlave_sclPipe[4]), .B (u_i2cSlave_sclPipe[3]),
       .Y (n_66));
  DFFPOSX1 \u_i2cSlave_sclDelayed_reg[4] (.CLK (clk), .D (n_65), .Q
       (u_i2cSlave_sclDelayed[4]));
  DFFPOSX1 \u_i2cSlave_sdaPipe_reg[4] (.CLK (clk), .D (n_64), .Q
       (u_i2cSlave_sdaPipe[4]));
  DFFPOSX1 \u_i2cSlave_sclPipe_reg[4] (.CLK (clk), .D (n_63), .Q
       (u_i2cSlave_sclPipe[4]));
  OR2X1 g509(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclDelayed[3]),
       .Y (n_65));
  OR2X1 g480(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sdaPipe[3]), .Y
       (n_64));
  OR2X1 g482(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclPipe[3]), .Y
       (n_63));
  DFFPOSX1 \u_i2cSlave_sclDelayed_reg[3] (.CLK (clk), .D (n_60), .Q
       (u_i2cSlave_sclDelayed[3]));
  DFFPOSX1 \u_i2cSlave_sdaPipe_reg[3] (.CLK (clk), .D (n_57), .Q
       (u_i2cSlave_sdaPipe[3]));
  DFFPOSX1 \u_i2cSlave_sclPipe_reg[3] (.CLK (clk), .D (n_56), .Q
       (u_i2cSlave_sclPipe[3]));
  DFFPOSX1 \u_i2cSlave_startStopDetState_reg[0] (.CLK (clk), .D (n_55),
       .Q (u_i2cSlave_startStopDetState[0]));
  OR2X1 g535(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclDelayed[2]),
       .Y (n_60));
  DFFPOSX1 \u_i2cSlave_startStopDetState_reg[1] (.CLK (clk), .D (n_54),
       .Q (ack_received));
  NAND2X1 g469(.A (u_i2cSlave_sdaPipe[2]), .B (u_i2cSlave_sdaPipe[1]),
       .Y (n_59));
  NAND2X1 g476(.A (u_i2cSlave_sclPipe[2]), .B (u_i2cSlave_sclPipe[1]),
       .Y (n_58));
  OR2X1 g484(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sdaPipe[2]), .Y
       (n_57));
  OR2X1 g486(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclPipe[2]), .Y
       (n_56));
  OAI21X1 g455(.A (n_48), .B (n_53), .C (n_52), .Y (n_55));
  DFFPOSX1 \u_i2cSlave_sclDelayed_reg[2] (.CLK (clk), .D (n_50), .Q
       (u_i2cSlave_sclDelayed[2]));
  DFFPOSX1 u_i2cSlave_startEdgeDet_reg(.CLK (clk), .D (n_145), .Q
       (u_i2cSlave_startEdgeDet));
  OAI21X1 g456(.A (n_51), .B (n_53), .C (n_47), .Y (n_54));
  DFFPOSX1 \u_i2cSlave_sdaPipe_reg[2] (.CLK (clk), .D (n_45), .Q
       (u_i2cSlave_sdaPipe[2]));
  DFFPOSX1 \u_i2cSlave_sclPipe_reg[2] (.CLK (clk), .D (n_44), .Q
       (u_i2cSlave_sclPipe[2]));
  NAND3X1 g458(.A (u_i2cSlave_startStopDetState[0]), .B (n_51), .C
       (n_46), .Y (n_52));
  OR2X1 g543(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclDelayed[1]),
       .Y (n_50));
  NAND3X1 g457(.A (ack_received), .B (n_48), .C (n_46), .Y (n_47));
  OR2X1 g488(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sdaPipe[1]), .Y
       (n_45));
  OR2X1 g490(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclPipe[1]), .Y
       (n_44));
  DFFPOSX1 \u_i2cSlave_sclDelayed_reg[1] (.CLK (clk), .D (n_43), .Q
       (u_i2cSlave_sclDelayed[1]));
  NAND3X1 g463(.A (n_42), .B (u_i2cSlave_sclDeb), .C
       (u_i2cSlave_sdaDelayed[0]), .Y (n_51));
  DFFPOSX1 \u_i2cSlave_sdaPipe_reg[1] (.CLK (clk), .D (n_41), .Q
       (u_i2cSlave_sdaPipe[1]));
  DFFPOSX1 \u_i2cSlave_sclPipe_reg[1] (.CLK (clk), .D (n_40), .Q
       (u_i2cSlave_sclPipe[1]));
  NAND3X1 g462(.A (u_i2cSlave_sdaDelayed[1]), .B (u_i2cSlave_sclDeb),
       .C (n_38), .Y (n_48));
  OR2X1 g545(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclDelayed[0]),
       .Y (n_43));
  INVX1 g474(.A (u_i2cSlave_sdaDelayed[1]), .Y (n_42));
  OR2X1 g492(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sdaPipe[0]), .Y
       (n_41));
  OR2X1 g494(.A (u_i2cSlave_rstPipe[1]), .B (u_i2cSlave_sclPipe[0]), .Y
       (n_40));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[6] (.CLK (clk),
       .D (n_31), .Q (u_i2cSlave_dataFromRegIF[6]));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[0] (.CLK (clk),
       .D (n_37), .Q (u_i2cSlave_dataFromRegIF[0]));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[5] (.CLK (clk),
       .D (n_32), .Q (u_i2cSlave_dataFromRegIF[5]));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[2] (.CLK (clk),
       .D (n_35), .Q (u_i2cSlave_dataFromRegIF[2]));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[4] (.CLK (clk),
       .D (n_33), .Q (u_i2cSlave_dataFromRegIF[4]));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[7] (.CLK (clk),
       .D (n_30), .Q (u_i2cSlave_dataFromRegIF[7]));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[3] (.CLK (clk),
       .D (n_34), .Q (u_i2cSlave_dataFromRegIF[3]));
  DFFPOSX1 \u_i2cSlave_u_registerInterface_dataOut_reg[1] (.CLK (clk),
       .D (n_36), .Q (u_i2cSlave_dataFromRegIF[1]));
  DFFPOSX1 \u_i2cSlave_sdaDelayed_reg[1] (.CLK (clk), .D (n_39), .Q
       (u_i2cSlave_sdaDelayed[1]));
  DFFPOSX1 \u_i2cSlave_sclDelayed_reg[0] (.CLK (clk), .D (n_29), .Q
       (u_i2cSlave_sclDelayed[0]));
  DFFPOSX1 \u_i2cSlave_sdaDelayed_reg[0] (.CLK (clk), .D (n_28), .Q
       (u_i2cSlave_sdaDelayed[0]));
  DFFPOSX1 \u_i2cSlave_sdaPipe_reg[0] (.CLK (clk), .D (n_27), .Q
       (u_i2cSlave_sdaPipe[0]));
  DFFPOSX1 \u_i2cSlave_sclPipe_reg[0] (.CLK (clk), .D (n_26), .Q
       (u_i2cSlave_sclPipe[0]));
  INVX2 g471(.A (n_46), .Y (n_53));
  NAND2X1 g479(.A (n_70), .B (n_38), .Y (n_39));
  NAND2X1 g510(.A (n_25), .B (n_21), .Y (n_37));
  NAND2X1 g511(.A (n_9), .B (n_20), .Y (n_36));
  NAND2X1 g512(.A (n_24), .B (n_17), .Y (n_35));
  NAND2X1 g513(.A (n_15), .B (n_16), .Y (n_34));
  NAND2X1 g514(.A (n_13), .B (n_14), .Y (n_33));
  NAND2X1 g515(.A (n_11), .B (n_12), .Y (n_32));
  NAND2X1 g516(.A (n_8), .B (n_10), .Y (n_31));
  NAND2X1 g517(.A (n_7), .B (n_6), .Y (n_30));
  NAND2X1 g547(.A (n_70), .B (n_1), .Y (n_29));
  OR2X1 g452(.A (u_i2cSlave_sdaDeb), .B (u_i2cSlave_rstPipe[1]), .Y
       (n_28));
  OR2X2 g508(.A (u_i2cSlave_startEdgeDet), .B (u_i2cSlave_rstPipe[1]),
       .Y (u_i2cSlave_n_144));
  NOR2X1 g472(.A (u_i2cSlave_rstPipe[1]), .B
       (u_i2cSlave_clearStartStopDet), .Y (n_46));
  OR2X1 g496(.A (sda), .B (u_i2cSlave_rstPipe[1]), .Y (n_27));
  OR2X1 g497(.A (scl), .B (u_i2cSlave_rstPipe[1]), .Y (n_26));
  AOI22X1 g519(.A (sampleOut[24]), .B (n_23), .C (sampleOut[8]), .D
       (n_22), .Y (n_25));
  AOI22X1 g520(.A (sampleOut[26]), .B (n_23), .C (sampleOut[10]), .D
       (n_22), .Y (n_24));
  AOI22X1 g521(.A (sampleOut[16]), .B (n_19), .C (sampleOut[0]), .D
       (n_18), .Y (n_21));
  AOI22X1 g522(.A (sampleOut[17]), .B (n_19), .C (sampleOut[1]), .D
       (n_18), .Y (n_20));
  AOI22X1 g524(.A (sampleOut[18]), .B (n_19), .C (sampleOut[2]), .D
       (n_18), .Y (n_17));
  AOI22X1 g525(.A (sampleOut[19]), .B (n_19), .C (sampleOut[3]), .D
       (n_18), .Y (n_16));
  AOI22X1 g526(.A (sampleOut[27]), .B (n_23), .C (sampleOut[11]), .D
       (n_22), .Y (n_15));
  AOI22X1 g527(.A (sampleOut[20]), .B (n_19), .C (sampleOut[4]), .D
       (n_18), .Y (n_14));
  AOI22X1 g528(.A (sampleOut[28]), .B (n_23), .C (sampleOut[12]), .D
       (n_22), .Y (n_13));
  AOI22X1 g529(.A (sampleOut[21]), .B (n_19), .C (sampleOut[5]), .D
       (n_18), .Y (n_12));
  AOI22X1 g530(.A (sampleOut[29]), .B (n_23), .C (sampleOut[13]), .D
       (n_22), .Y (n_11));
  AOI22X1 g531(.A (sampleOut[22]), .B (n_19), .C (sampleOut[6]), .D
       (n_18), .Y (n_10));
  AOI22X1 g523(.A (sampleOut[25]), .B (n_23), .C (sampleOut[9]), .D
       (n_22), .Y (n_9));
  AOI22X1 g532(.A (sampleOut[30]), .B (n_23), .C (sampleOut[14]), .D
       (n_22), .Y (n_8));
  AOI22X1 g534(.A (sampleOut[31]), .B (n_23), .C (sampleOut[15]), .D
       (n_22), .Y (n_7));
  AOI22X1 g533(.A (sampleOut[23]), .B (n_19), .C (sampleOut[7]), .D
       (n_18), .Y (n_6));
  INVX2 g548(.A (u_i2cSlave_rstPipe[1]), .Y (n_70));
  DFFPOSX1 \u_i2cSlave_rstPipe_reg[1] (.CLK (clk), .D (n_5), .Q
       (u_i2cSlave_rstPipe[1]));
  TBUFX2 u_i2cSlave_g1A(.A (1'b1), .EN (n_3), .Y (sda));
  TBUFX2 u_i2cSlave_g1B(.A (1'b1), .EN (n_3), .Y (sda));
  TBUFX2 u_i2cSlave_g1C(.A (1'b1), .EN (n_3), .Y (sda));
  TBUFX2 u_i2cSlave_g1D(.A (1'b1), .EN (n_3), .Y (sda));
  NOR2X1 g537(.A (u_i2cSlave_regAddr[1]), .B (n_4), .Y (n_19));
  NOR2X1 g538(.A (u_i2cSlave_regAddr[0]), .B (n_2), .Y (n_22));
  OR2X1 g550(.A (rst), .B (u_i2cSlave_rstPipe[0]), .Y (n_5));
  AND2X2 g539(.A (u_i2cSlave_regAddr[0]), .B (u_i2cSlave_regAddr[1]),
       .Y (n_18));
  NOR2X1 g540(.A (u_i2cSlave_regAddr[1]), .B (u_i2cSlave_regAddr[0]),
       .Y (n_23));
  DFFPOSX1 \u_i2cSlave_rstPipe_reg[0] (.CLK (clk), .D (rst), .Q
       (u_i2cSlave_rstPipe[0]));
  INVX2 g541(.A (u_i2cSlave_regAddr[0]), .Y (n_4));
  INVX1 g498(.A (u_i2cSlave_sdaOut), .Y (n_3));
  INVX2 g542(.A (u_i2cSlave_regAddr[1]), .Y (n_2));
  INVX2 g553(.A (u_i2cSlave_sdaDelayed[0]), .Y (n_38));
  INVX1 g552(.A (u_i2cSlave_sclDeb), .Y (n_1));
  OAI21X1 g2(.A (u_i2cSlave_sclPipe[3]), .B (u_i2cSlave_sclPipe[4]), .C
       (u_i2cSlave_sclDeb), .Y (n_141));
  OAI21X1 g840(.A (u_i2cSlave_sdaPipe[3]), .B (u_i2cSlave_sdaPipe[4]),
       .C (u_i2cSlave_sdaDeb), .Y (n_142));
  OAI21X1 g841(.A (u_i2cSlave_sclPipe[1]), .B (u_i2cSlave_sclPipe[2]),
       .C (u_i2cSlave_sclDeb), .Y (n_143));
  OAI21X1 g842(.A (u_i2cSlave_sdaPipe[1]), .B (u_i2cSlave_sdaPipe[2]),
       .C (u_i2cSlave_sdaDeb), .Y (n_144));
  NOR2X1 g843(.A (n_48), .B (u_i2cSlave_rstPipe[1]), .Y (n_145));
endmodule
